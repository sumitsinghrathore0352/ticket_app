...
import 'package:ticket_booking_app/widgets/icons_text_widget.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          AppTicketTabs(firstTab: 'Aireline tickets', secondTab: 'Hotels',),
          ...
          Gap(AppLayout.getHeight(25)),
          Container(
                  padding: EdgeInsets.symmetric(horizontal: AppLayout.getWidth(17),vertical: AppLayout.getWidth(17)),
            ...
            height: AppLayout.getHeight(420),
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "20% discount  on the early booking of the flights , Don't miss the chance",
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: Styles.headLineStyle1.copyWith(fontWeight: FontWeight.w500, color: Colors.white, fontSize: 18),
                              ),
                            ],
                          ),
                        ),
